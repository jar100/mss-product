...
import com.jar100.mssproduct.controller.dto.CategoryMinPrice;
...
public class PriceController {
    ...
    public CommonResponse<List<CategoryMinPrice>> findLowesByCategories() {
    ...
    public CommonResponse<List<CategoryMinPrice>> findLowestByBrands() {
    ...
    public CommonResponse<CategoryMinPrice> findRangeByCategory(@PathVariable String categoryName) {
